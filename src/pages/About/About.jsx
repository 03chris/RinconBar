            ...
            <Container>
                <Row>
                    <Col sm={6} className="text-about">
                        ...
                        <p className='mb-2'>Así es como en el 2016 nace RINCON. Hoy cuenta con 7 locales en Argentina. Como si esto fuera poco, en el 2019, llegamos a Europa con un local RINCON en Paris. El primero de 4 locales con aperturas programadas para el proximo año en otras ciudades europeas.</p> 
